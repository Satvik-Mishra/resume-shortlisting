...
<center>
    ...
    <form action="login.php" method="POST">
        <button style="padding: 10px 20px; background-color: #4CAF50; color: #fff; border: none; border-radius: 5px; font-size: 18px; cursor: pointer; transition: background-color 0.3s ease;">Click here to view all records</button>
    </form>
</center>
        ...
        <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="9999999999" required>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>Skills (Max:5)</h2>
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Experience(yrs)</label>
