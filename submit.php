...
if (Token == $_POST['token']) {
  ...
  $stmt = $conn->prepare("INSERT INTO resumes (first_name, last_name, profession, email, phone, about_me, experience, skills, degrees,cgpa) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

  // Bind the parameters and execute the statement
  $stmt->bind_param("sssssssssi", $first_name, $last_name, $profession, $email, $phone, $about_me, $experience, $allSkills ,$alldegree,$allcgpa);
  $experience = implode(", ", $titles);
  $allSkills = implode(", ", $skills);
  $alldegree=implode(",", $degrees);
  $allcgpa=implode(",",$grades);
...
$page = 'records.php'; // The page you want to link to
...
<div class="grid-container">
  ...
  <div class="zone-2">
    <div class="headTitle">
      <h1><b><?php echo ucwords($first_name);?><br><?php echo ucwords($last_name);?></b></h1>
    </div>
    <div class="subTitle">
...
<center><button class ="button" onclick="printFunction()">Print</button>
</center>
